...
| `ADMIN_PASSWORD` / `ADMIN_USERNAME` | `admin123` / `admin` | change before first start — the first boot seeds this account |
...
- **Route-scope rules** apply to both API keys and session cookies (admin routes require admin scope).
